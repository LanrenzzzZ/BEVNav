...
actor_pkg_path = rospack.get_path("multi_robot_scenario")

tree_ = etree.parse(actor_pkg_path + '/launch/' + 'TD3-2.world')
...
tree_.write(actor_pkg_path+'/launch/TD3-2.world', pretty_print=True, xml_declaration=True, encoding="utf-8")
